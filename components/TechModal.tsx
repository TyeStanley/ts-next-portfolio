    ...
    <>
      <Transition as={Fragment} appear show={isOpen}>
        ...
        >
          ...
          >
            <div className="fixed inset-0 flex items-center justify-center border-2 border-sky-500 bg-gray-200/40 p-5 text-center">
              <Dialog.Panel className="border border-sky-400 bg-gray-100 p-1 md:w-[650px] md:p-5 lg:w-[800px]">
                <Dialog.Title className="mt-5 text-lg font-extrabold text-sky-900 md:text-[1.5rem] lg:text-[1.75rem]">
                  {title}
                </Dialog.Title>
                <div className="line-pulse mx-auto mt-5 h-[1px] w-[100px] bg-sky-500" />

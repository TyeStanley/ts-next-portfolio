...
const homepageImage = require("../assets/portfolio.png");
  ...
  return (
    <>
      <Head>
        <>
          <DefaultSeo
            title="Full Stack Developer | Tye Stanley"
            description="Welcome to my homepage! I'm a full stack developer with a passion for creating beautiful and functional websites. I'm currently looking for a full time position as a web developer."
            openGraph={{
              images: [
                {
                  url: homepageImage,
                  alt: "Tye Stanley's Homepage",
                },
              ],
            }}
          />
